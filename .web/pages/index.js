...
import { Box, Button, Container, HStack, Input, Modal, ModalBody, ModalContent, ModalHeader, ModalOverlay, Text } from "@chakra-ui/react"
...
export default function Component() {
  ...
  <Container>
  <Box>
  {state.chat_history.map((uhpdfoxb, pwfbrdzq) => (
  <Box key={pwfbrdzq} sx={{"marginY": "1em"}}>
